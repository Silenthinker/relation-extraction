...
class AttentionLSTM(LSTM):
    def __init__(self, vocab_size, tagset_size, args):
        ...
        self.attention = Attention(args.hidden_dim, args.att_hidden_dim, args.num_hops)
    ...
    def forward(self, sentence, position, hidden=None):
        ...
        att_weight = self.attention(lstm_out) # batch_size, seq_length, num_hops
        ...
        output = self.att2out(sent_repr) # output: batch_size, tagset_size
